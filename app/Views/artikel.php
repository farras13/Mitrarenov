              ...
              <div class="article-slider">
                ...
                <div class="article-slider-item">
                  <div class="article-img">
                    <img src="<?= base_url() ?>images/article-sd.jpg" alt="">
                  </div>
                  <h4 class="mt-3 mb-2"><?= $h->title ?></h4>
                  <p class="text-grey mb-0"><?= $h->penulis ?></p>
                  <p class="text-grey mb-0">Diterbitkan <?php $time=$h->created; $date = new DateTime("@$time"); echo $date->format('d M Y'); ?></p>
                  <p>
                   <?= $h->meta_description ?> ...
                  </p>
            ...
            <div class="article-list-small">
              ...
              <div class="d-flex article-item-small">
                ...
                <div class="w-100 pl-4">
                  ...
                  <p class="text-grey mb-0">Diterbitkan <?php $time=$tb['created']; $date = new DateTime("@$time"); echo $date->format('d M Y'); ?></p>
                  <p>
                    <?= $h->meta_description ?> ...
                  </p>
                  <div class="text-right">
