	...
	<div id="content">
		...
		<xsl:if test="count(sitemap:sitemapindex/sitemap:sitemap) &gt; 0">
			...
			<table id="sitemap" cellpadding="3">
				...
				<tbody>
					<tr>
						<td><a href="<?= base_url('desain_rumah'); ?>"><loc><?= base_url('desain_rumah'); ?></loc></a></td>
						<td><lastmod><?= date('Y-m-d') ?></lastmod></td>
					</tr>
					<?php foreach($data as $m): ?>
					<tr>
						<td><a href="<?= base_url('desain_rumah/' . $m->slug); ?>"><loc><?= base_url('desain_rumah/' . $m->slug); ?></loc></a></td>
						<td><lastmod><?= date('Y-m-d', $m->created) ?></lastmod></td>
					</tr>
					<?php endforeach; ?>
				</tbody>
			</table>
