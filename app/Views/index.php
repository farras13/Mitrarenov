    ...
    <div class="top-banner">
      ...
      <?php foreach ($promo as $p) : ?>
        <div class="slick-slide slide-item">
          <img src="<?= base_url('main/images/slider-1.jpg') ?>" class="w-100" alt="">

          <!-- <?php if ($p->image == null) { ?>
            <img src="<?= base_url('main/images/slider-1.jpg') ?>" class="w-100" alt="">
          <?php } else { ?>
            <img src="<?= base_url('images/promo') . '/' . $p->imagecontent ?>" class="w-100"  alt="">
          <?php } ?> -->
        ...
        <?php foreach ($artikel as $art) : ?>
          <div class="article-item">
            <div class="article-img">
             <img src="<?= base_url('images/news/thumbs') . '/' . $art->image ?>" alt="">
            </div>
    ...
    <div class="section-inner position-relative mt-5">
      <div class="client-slide">
        ...
        <div class="client-item">
          <img src="<?= base_url('images/partner_icon/'.$p->image) ?>" class="img-fluid" alt="">
        </div>
        <?php endforeach ?>
